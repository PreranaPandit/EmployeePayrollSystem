...
class Login extends CI_Controller {
	...
	if($this->form_validation->run() == FALSE){
		...
		//$data['error'] = 'UserEmail or Password is  Invalid';  
			
			$data['error']="<h3 style='color: white;text-align:center;background-color:DodgerBlue;border:2px solid black'>Invalid Email-Id or Password</h3>";
