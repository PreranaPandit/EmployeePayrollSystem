                                ...
                                <div class="col-md-12">
                                    <table class="table table-condensed borderless" style="border-left: 1px solid #ececec;">
                                        ...
                                        <tbody style="border: 1px solid #ececec;">
                                            <tr>
                                                <td>Basic Salary</td>
                                                <td class="text-right">Rs.<?php echo $addition[0]->basic; ?></td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>Medical Allowance</td>
                                                <td class="text-right">Rs. <?php echo $addition[0]->medical; ?> </td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>House Rent</td>
                                                <td class="text-right">Rs.<?php echo $addition[0]->house_rent; ?></td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>Conveyance Allowance</td>
                                                <td class="text-right">Rs.<?php echo $addition[0]->conveyance; ?></td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>Bonus</td>
                                        ...
                                        <tfoot class="tfoot-light">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-right">Rs.<?php echo $salary_info->total_pay/*round($total_add - $total_did,2)*/; ?></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="table-responsive" style="clear: both;">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Basic Salary</td>
                                                    <td class="text-right"> Rs.<?php echo $salaryvaluebyid->basic;?></td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>Madical</td>
                                                    <td class="text-right"> Rs.<?php echo $salaryvaluebyid->medical;?>  </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>House Rent</td>
                                                    <td class="text-right"> Rs.<?php echo $salaryvaluebyid->house_rent;?>  </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>Conveyance</td>
                                                    <td class="text-right"> Rs.<?php echo $salaryvaluebyid->conveyance;?>  </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>Loan</td>
                                                    <td class="text-right"> </td>
                                                    <td class="text-right">Rs.<?php echo $salary_info->loan;?>  </td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                                <tr>
                                                    <th>Total</th>
                                                    <th class="text-right">Rs.<?php echo $salaryvaluebyid->total;?> </th>
                                                    <th class="text-right">Rs.<?php echo $salary_info->diduction;?> </th>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="pull-right m-t-30 text-right">
                                        <h3><b>Total :</b>  Rs.<?php echo $salary_info->total_pay;?></h3>
                                    </div>
