            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    ...
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item"><a href="<?php echo base_url('assets/images/EPS_UserGuide.pdf');?>"><h5 class="text-themecolor"><Span></Span>User Manual<span></h5></a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    ?>  Employees</h3>
                                        <a href="" class="">Total Employees</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url(); ?>Projects/All_Projects" class="">View Project</a>
                                    </div>
                                </div>
                            </div>
                        </div>
