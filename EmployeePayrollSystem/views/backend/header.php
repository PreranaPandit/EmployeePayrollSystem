...
<head>
    ...
    <meta name="author" content="GenIT Kathmandu">
    <!-- Favicon icon -->
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <h5 align='center'>&#9997;Hello <?php echo $basicinfo->first_name; ?>!!..</h5>
                                            <h6 align='center'>Please feel free to contact us!!..&#128513&#128515</h6>
                                            <br><hr><hr>
                                            <a href="#">
                                                <div class="btn btn-danger btn-circle"><i class="fa fa-link"></i></div>
                                                <div class="mail-contnet">
                                               
                                                    <h6><?php echo $settingsvalue->system_email; ?></h6> <span class="mail-desc"><?php echo $settingsvalue->address; ?></span> <span class="mail-desc"><?php echo $settingsvalue->contact; ?></span> </div>
                                            </a>
                                           
                                        </div>
                                    </li>
                                    <li>
                                        <a class="nav-link text-center" href="javascript:void(0);"> <strong>Thank You For Chosing Us..</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
