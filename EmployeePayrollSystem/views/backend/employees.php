                                           ...
                                           <?php foreach($employee as $value): ?>
                                            <tr>
                                                ...
                                                <td class="jsgrid-align-center ">
                                                    ...
                                                    <a href="DeletEmployee?D=<?php echo $value->id; ?>" onclick="confirm('Are you sure want to remove this employee?')" title="Delete" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
