        ...
        <div class="login-box card">
            <div class="card-body loginpage">
                ...
                <form class="form-horizontal form-material" method="post" id="loginform" action="login/Login_Auth">
                 <h2 style="color:Blue;font-size:200%;font-family:Elianto" align="center">Employee Payroll System</h2><br/>
                 
                  
                    <?php echo @$error; ?>
                    <div class="form-group m-t-40">
                        <div class="col-xs-12">
                            <input class="form-control" name="email" value="<?php if(isset($_COOKIE['email'])) { echo $_COOKIE['email']; } ?>" type="text" required placeholder="Email-address">
                        </div>
                    </div>
